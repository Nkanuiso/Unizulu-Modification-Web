   ...
   <nav class="navH">
       ...
       <div class="Menu_div" x-data = "{open: false}" @click="open=!open">
           ...
           <div x-show ="open" @click.outside = "open=false" class="Drop_down">
               <p class="username"><?php echo e(auth()->user()->username); ?></p><br>
               <a class= "form" href="<?php echo e(route('form')); ?>">form</a> <br>
               <a class= "homeRoute" href="<?php echo e(route('home')); ?>">Home</a><br>
...
</html><?php /**PATH C:\Xampp\htdocs\Online-Modification\resources\views/welcome.blade.php ENDPATH**/ ?>